...
public class RTCMissingAttrException extends Exception {
    ...
    /**
     * Exception raised when a required attribute of the IBM Ant Task is missing.
     * 
     * @param clss Ant Task bean.
     * @param attribute Missing attribute.
     */
    public RTCMissingAttrException(Class<? extends BaseTask> clss, String attribute) {
	super(String.format(ERROR_MESSAGE, attribute, clss.getName()));
    }
    
    /**
     * Exception raised when none of a pair of mutually exclusive attributes of the IBM Ant Task is missing (i.e. password and passwordFile).
     * 
     * @param clss Ant Task bean.
     * @param attrA One of the missing mutex attribute.
     * @param attrB The other missing mutex attribute.
     */
    public RTCMissingAttrException(Class<? extends BaseTask> clss, String attrA, String attrB) {
