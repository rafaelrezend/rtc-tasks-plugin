...
public class RTCBuildActivity extends Builder implements SimpleBuildStep {
	...
	public RTCBuildActivity(String label, String buildResultUUID,
	...
	private void writeStartBuildActivityFile(String resolvedBuildResultUUID,
		...
		antDoc.addEcho(this.activityIdProperty + "=${"
	...
	private void writeCompleteBuildActivityFile(String resolvedBuildResultUUID,
			EnvVars envs, FilePath scriptFilePath, String activityId)
			throws IllegalAccessException, RTCMissingAttrException,
			RTCConflictAttrException, ParserConfigurationException,
			IOException, InterruptedException, TransformerException,
			RTCDependentAttrException {
